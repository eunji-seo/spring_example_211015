...
<body>
	...
	통와(달러):<fmt:formatNumber value="${number}" type="currency" currencySymbol="$"/><br>
	...
	3.14(#.####):<fmt:formatNumber value="3.14" pattern="#.####" /><br> <%-- 있는숫자대로 나타낸다 --%>
	...
	${today}<br>
	<fmt:formatDate value="${today}" pattern="yyyy년 mm월 dd일 HH시 MM분 ss초" var="pattern1"/> <%-- EL로 출력해야 나옴 --%>
	${pattern1}<br>
